...
{
    public class ItemSelectHandler : ICommerceHandler
    {
        ...
        public void Execute( Telegram.Bot.ITelegramBotClient client, Message message )
        {
            ...
            if ( menu != null )
            {
                ...
                if ( items.Count() > 0 )
                {
                    ...
                    {
                        cart.AddCartItem( new Models.CartItem( user.Id, user.ExternalId ) );
                    ...
                    else
                    {
                        client.SendTextMessageAsync(
                            chatId: message.Chat.Id,
                            text: Words.Word( "order__prevOrderNotCompleted" ),
                            parseMode: Telegram.Bot.Types.Enums.ParseMode.Html,
